...
def nlp_cnn(x):
    ...
    convolution_prejects = "CNN" in x.text or "convolution" in x.text
    return nlp_projects and convolution_prejects
...
def get_metrics(
    ...
    Args:
        ...
        df (pd.DataFrame, optional): dataframe to generate slice metric on. Defaults to None.
