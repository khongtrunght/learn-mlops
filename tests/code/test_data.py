...
class TestLabelEncoder:
    @classmethod
    def setup_class(cls):
        """Called before every class initalization."""
        pass

    @classmethod
    def teardown_class(cls):
        """Called after every class initalization."""
        pass
    ...
    def test_str(self):
        assert str(self.label_encoder) == "<LabelEncoder(num_classes=0)>"

    def test_fit(self):
        label_encoder = data.LabelEncoder()
        label_encoder.fit(["apple", "banana", "apple"])
